...
export const articles: Article[] = [
  {
    ...
    date: "March 15, 2026",
    excerpt:
      "The OECD's final administrative guidance resolves several contested interpretive questions under the Global Anti-Base Erosion rules, including the treatment of deferred tax assets and the scope of the Undertaxed Profits Rule. Marcus Webb, Partner in Meridian's International Tax practice, provides a detailed technical walkthrough for compliance and planning teams.",
...
Looking ahead to the second half of 2026, the conditions for a mid-market M&A recovery are broadly in place. Interest rate stabilisation has improved leveraged buyout economics, strategic acquirers have rebuilt balance sheet capacity, and private equity sponsors are facing mounting pressure to realise returns from ageing portfolio investments. Meridian expects deal flow to increase approximately 20-25% in the mid-market segment relative to 2025 levels, with business services, industrial technology, and specialty healthcare services as the most active sectors.`,
  },
  {
