      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <p className="text-lg text-slate-600 mb-8">
            The technology sector operates at lightning speed. Meridian Partners helps TMT companies scale efficiently, manage rapid hypergrowth, and handle complex IP tax structuring and global compliance.
          </p>
